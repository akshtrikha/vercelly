...
export async function upload(id: string, files: string[], bucket: any) {
    let filesToUpload = files.filter((file) => { return file.includes(".git") === false });       //! Removing .git files for testing. Revert this change.
